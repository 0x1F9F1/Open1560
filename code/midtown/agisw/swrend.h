...
inline extern_var(0x652260, i32, BACKFACE);

// 0x796048 | ?BADEDGE@@3HA
inline extern_var(0x796048, i32, BADEDGE);

// 0x795F70 | ?EnableParabolic@@3HA
inline extern_var(0x795F70, i32, EnableParabolic);

// 0x795F4C | ?FLIPLOD@@3HA
inline extern_var(0x795F4C, i32, FLIPLOD);

// 0x65225C | ?FLIPWINDING@@3HA
inline extern_var(0x65225C, i32, FLIPWINDING);

// 0x79FF10 | ?LODBIAS@@3HA
inline extern_var(0x79FF10, i32, LODBIAS);

// 0x65226C | ?PERSP2@@3HA
inline extern_var(0x65226C, i32, PERSP2);

// 0x652270 | ?PERSP_THRESH@@3MA
inline extern_var(0x652270, f32, PERSP_THRESH);

// 0x6522C0 | ?QUADS@@3HA
inline extern_var(0x6522C0, i32, QUADS);

// 0x652264 | ?XPTHRESH@@3HA
inline extern_var(0x652264, i32, XPTHRESH);

// 0x652268 | ?YPTHRESH@@3HA
inline extern_var(0x652268, i32, YPTHRESH);

// 0x795F84 | ?debugTri@@3HA
inline extern_var(0x795F84, i32, debugTri);

// 0x795FA8 | ?debugTriGate@@3HA
inline extern_var(0x795FA8, i32, debugTriGate);

// 0x79BEE8 | ?debugTriMatch@@3HA
inline extern_var(0x79BEE8, i32, debugTriMatch);

// 0x795FAC | ?swActualScreenStride@@3IA
inline extern_var(0x795FAC, u32, swActualScreenStride);

// 0x795FFC | ?swBlueMask@@3HA
inline extern_var(0x795FFC, i32, swBlueMask);

// 0x7960B0 | ?swBytesPerPixel@@3HA
inline extern_var(0x7960B0, i32, swBytesPerPixel);

// 0x795FB0 | ?swClampAdd@@3P6IIII@ZA
inline extern_var(0x795FB0, u32(__fastcall*)(u32, u32), swClampAdd);

// 0x795F54 | ?swCurrentDepthLine@@3PAGA
inline extern_var(0x795F54, u16*, swCurrentDepthLine);

// 0x7960D0 | ?swCurrentLut@@3PAGA
inline extern_var(0x7960D0, u16*, swCurrentLut);

// 0x7960AC | ?swCurrentScanline@@3PAXA
inline extern_var(0x7960AC, void*, swCurrentScanline);

// 0x795F48 | ?swDepthBuffer@@3PAGA
inline extern_var(0x795F48, u16*, swDepthBuffer);

// 0x7960BC | ?swFbEnd@@3P6AXXZA
inline extern_var(0x7960BC, void (*)(void), swFbEnd);

// 0x795F74 | ?swFbEndFrame@@3P6AXXZA
inline extern_var(0x795F74, void (*)(void), swFbEndFrame);

// 0x7960C8 | ?swFbEndScene@@3P6AXXZA
inline extern_var(0x7960C8, void (*)(void), swFbEndScene);

// 0x65204C | ?swFbHeight@@3HA
inline extern_var(0x65204C, i32, swFbHeight);

// 0x7960B4 | ?swFbParent@@3PAXA
inline extern_var(0x7960B4, void*, swFbParent);

// 0x7960CC | ?swFbStart@@3P6AXXZA
inline extern_var(0x7960CC, void (*)(void), swFbStart);

// 0x795F60 | ?swFbStartFrame@@3P6AXXZA
inline extern_var(0x795F60, void (*)(void), swFbStartFrame);

// 0x795FF8 | ?swFbStartScene@@3P6AXXZA
inline extern_var(0x795FF8, void (*)(void), swFbStartScene);

// 0x652048 | ?swFbWidth@@3HA
inline extern_var(0x652048, i32, swFbWidth);

// 0x79FF08 | ?swFbX@@3HA
inline extern_var(0x79FF08, i32, swFbX);

// 0x79FF0C | ?swFbY@@3HA
inline extern_var(0x79FF0C, i32, swFbY);

// 0x7960B8 | ?swFrameOffset@@3IA
inline extern_var(0x7960B8, u32, swFrameOffset);

// 0x795FA0 | ?swGreenMask@@3HA
inline extern_var(0x795FA0, i32, swGreenMask);

// 0x79BEF0 | ?swInfo@@3UswRastInfo@@A
inline extern_var(0x79BEF0, struct swRastInfo, swInfo);

// 0x796044 | ?swIsInterlaced@@3HA
inline extern_var(0x796044, i32, swIsInterlaced);

// 0x795F78 | ?swPixelSizeShift@@3HA
inline extern_var(0x795F78, i32, swPixelSizeShift);

// 0x7960C0 | ?swRedMask@@3HA
inline extern_var(0x7960C0, i32, swRedMask);

// 0x795F50 | ?swScreen@@3PAXA
inline extern_var(0x795F50, void*, swScreen);

// 0x79FF04 | ?swScreenStride@@3IA
inline extern_var(0x79FF04, u32, swScreenStride);

// 0x795F7C | ?swStippleTest@@3PAEA
inline extern_var(0x795F7C, u8*, swStippleTest);

// 0x795F68 | ?swr_color@@3HA
inline extern_var(0x795F68, i32, swr_color);

// 0x796094 | ?swr_ddu@@3HA
inline extern_var(0x796094, i32, swr_ddu);

// 0x796098 | ?swr_ddv@@3HA
inline extern_var(0x796098, i32, swr_ddv);

// 0x7960C4 | ?swr_dest@@3PAXA
inline extern_var(0x7960C4, void*, swr_dest);

// 0x795F80 | ?swr_di@@3HA
inline extern_var(0x795F80, i32, swr_di);

// 0x795F88 | ?swr_du@@3HA
inline extern_var(0x795F88, i32, swr_du);

// 0x795F8C | ?swr_dv@@3HA
inline extern_var(0x795F8C, i32, swr_dv);

// 0x795F90 | ?swr_dz@@3HA
inline extern_var(0x795F90, i32, swr_dz);

// 0x796090 | ?swr_i@@3HA
inline extern_var(0x796090, i32, swr_i);

// 0x795F5C | ?swr_sizes@@3Tswr_sizes_t@@A
inline extern_var(0x795F5C, union swr_sizes_t, swr_sizes);

// 0x79FF00 | ?swr_src@@3PAXA
inline extern_var(0x79FF00, void*, swr_src);

// 0x795F6C | ?swr_texmask@@3HA
inline extern_var(0x795F6C, i32, swr_texmask);

// 0x79BEE4 | ?swr_texshift@@3HA
inline extern_var(0x79BEE4, i32, swr_texshift);

// 0x79604C | ?swr_texstride@@3HA
inline extern_var(0x79604C, i32, swr_texstride);

// 0x79609C | ?swr_u@@3HA
inline extern_var(0x79609C, i32, swr_u);

// 0x7960A0 | ?swr_v@@3HA
inline extern_var(0x7960A0, i32, swr_v);

// 0x7960A4 | ?swr_z@@3HA
inline extern_var(0x7960A4, i32, swr_z);

// 0x795F98 | ?swr_zb@@3PAGA
inline extern_var(0x795F98, u16*, swr_zb);
