...
public:
    ...
    i32 CheckBlitz(char* arg1, f32 arg2, i32 arg3, char* arg4, i32 arg5, i32 arg6);

    // 0x4CD200 | ?CheckCheckpoint@mmMiscData@@QAEHPADMH0HH@Z
    i32 CheckCheckpoint(char* arg1, f32 arg2, i32 arg3, char* arg4, i32 arg5, i32 arg6);

    // 0x4CD3A0 | ?CheckCircuit@mmMiscData@@QAEHPADMH0HH@Z
    i32 CheckCircuit(char* arg1, f32 arg2, i32 arg3, char* arg4, i32 arg5, i32 arg6);

    // 0x4CCFA0 | ?GetBestBlitzScore@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestBlitzScore(i32 arg1, i32 arg2);

    // 0x4CCC10 | ?GetBestBlitzTime@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestBlitzTime(i32 arg1, i32 arg2);

    // 0x4CD0D0 | ?GetBestCircuitScore@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestCircuitScore(i32 arg1, i32 arg2);

    // 0x4CCD40 | ?GetBestCircuitTime@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestCircuitTime(i32 arg1, i32 arg2);

    // 0x4CCE70 | ?GetBestRaceScore@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestRaceScore(i32 arg1, i32 arg2);

    // 0x4CCAE0 | ?GetBestRaceTime@mmMiscData@@QAE?AVmmRecord@@HH@Z
    class mmRecord GetBestRaceTime(i32 arg1, i32 arg2);
