...
void agiBeginCones()
{
    return stub<cdecl_t<void>>(0x1111E0_Offset);
}

void agiConeLighter(u8* arg1, u32* arg2, u32* arg3, class agiMeshSet* arg4)
{
    return stub<cdecl_t<void, u8*, u32*, u32*, class agiMeshSet*>>(0x1112C0_Offset, arg1, arg2, arg3, arg4);
}
    ...
    class Vector3& arg1, class Vector3& arg2, class Vector3& arg3, f32 arg4, f32 arg5, class Vector3& arg6, i32 arg7)
{
    return stub<cdecl_t<void, class Vector3&, class Vector3&, class Vector3&, f32, f32, class Vector3&, i32>>(
        0x1111F0_Offset, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
}

void agiDrawCones()
{
    return stub<cdecl_t<void>>(0x1118F0_Offset);
}

void agiMeshLighterQuarter(u8* arg1, u32* arg2, u32* arg3, class agiMeshSet* arg4)
{
    return stub<cdecl_t<void, u8*, u32*, u32*, class agiMeshSet*>>(0x110730_Offset, arg1, arg2, arg3, arg4);
}

void agiMeshLighterReset()
{
    return stub<cdecl_t<void>>(0x110640_Offset);
}

void agiMeshLighterSpecular(u8* arg1, u32* arg2, u32* arg3, class agiMeshSet* arg4)
{
    return stub<cdecl_t<void, u8*, u32*, u32*, class agiMeshSet*>>(0x1119F0_Offset, arg1, arg2, arg3, arg4);
}

void agiMeshLighterTriple(u8* arg1, u32* arg2, u32* arg3, class agiMeshSet* arg4)
{
    return stub<cdecl_t<void, u8*, u32*, u32*, class agiMeshSet*>>(0x110AE0_Offset, arg1, arg2, arg3, arg4);
}

void agiMeshLighterUpdateColors()
{
    return stub<cdecl_t<void>>(0x1108F0_Offset);
}
