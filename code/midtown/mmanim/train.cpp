...
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC66D0_Offset, this);
}
...
void mmAnimTrain::CalculateCubics(i32 arg1, class Vector4& arg2, class Vector4& arg3, class Vector4& arg4)
{
    return stub<thiscall_t<void, mmAnimTrain*, i32, class Vector4&, class Vector4&, class Vector4&>>(
        0xC6890_Offset, this, arg1, arg2, arg3, arg4);
}
    ...
    class Vector4& arg5, class Vector4& arg6, class Vector4& arg7)
{
    return stub<thiscall_t<void, mmAnimTrain*, class Vector3&, class Vector3&, class Vector3&, class Vector3&,
        class Vector4&, class Vector4&, class Vector4&>>(
        0xC6A90_Offset, this, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
}

void mmAnimTrain::GetStart(f32 arg1, i32& arg2, f32& arg3)
{
    return stub<thiscall_t<void, mmAnimTrain*, f32, i32&, f32&>>(0xC6740_Offset, this, arg1, arg2, arg3);
}
...
void mmAnimTrain::Init(i32 arg1, char* arg2, char* arg3, class Vector3* arg4, i32 arg5, i32 arg6, f32* arg7)
{
    return stub<thiscall_t<void, mmAnimTrain*, i32, char*, char*, class Vector3*, i32, i32, f32*>>(
        0xC6080_Offset, this, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
}

void mmAnimTrain::PreCalcCubics()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC67C0_Offset, this);
}

void mmAnimTrain::Reset()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC6350_Offset, this);
}

void mmAnimTrain::ReverseCalcPathSpeed()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC65C0_Offset, this);
}

void mmAnimTrain::SetPathSpeed()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC65B0_Offset, this);
}

void mmAnimTrain::SolvePosition(class Vector3& arg1, f32& arg2)
{
    return stub<thiscall_t<void, mmAnimTrain*, class Vector3&, f32&>>(0xC65D0_Offset, this, arg1, arg2);
}

void mmAnimTrain::SolveXZCurve(class Vector3& arg1, class Vector3& arg2, f32 arg3)
{
    return stub<thiscall_t<void, mmAnimTrain*, class Vector3&, class Vector3&, f32>>(
        0xC6B70_Offset, this, arg1, arg2, arg3);
}

void mmAnimTrain::Update()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC63C0_Offset, this);
}

void mmAnimTrain::UpdatePathPosition()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC6460_Offset, this);
}

void mmAnimTrain::CalculateAudioPanning()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC6ED0_Offset, this);
}

void mmAnimTrain::CalculateDistToPlayer2()
{
    return stub<thiscall_t<void, mmAnimTrain*>>(0xC6E00_Offset, this);
}

f32 mmAnimTrain::CalculateDoppler(f32 arg1)
{
    return stub<thiscall_t<f32, mmAnimTrain*, f32>>(0xC6F20_Offset, this, arg1);
}
