...
{
    return stub<thiscall_t<void, mmCompRoster*>>(0x4B7C10, this);
}

void mmCompRoster::Init(char* arg1, char* arg2, char* arg3, u32 arg4)
{
    return stub<thiscall_t<void, mmCompRoster*, char*, char*, char*, u32>>(0x4B7940, this, arg1, arg2, arg3, arg4);
}
    ...
    struct LocString* arg7, struct LocString* arg8, i32 arg9)
{
    return stub<thiscall_t<void, mmCompRoster*, f32, f32, f32, f32, struct LocString*, struct LocString*,
        ...
        0x4B79C0, this, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
}

void mmCompRoster::LoadBitmap(char* arg1)
{
    return stub<thiscall_t<void, mmCompRoster*, char*>>(0x4B79D0, this, arg1);
}

void mmCompRoster::Reset()
{
    return stub<thiscall_t<void, mmCompRoster*>>(0x4B7A20, this);
}

void mmCompRoster::SetBltXY(f32 arg1, f32 arg2)
{
    return stub<thiscall_t<void, mmCompRoster*, f32, f32>>(0x4B7BD0, this, arg1, arg2);
}

void mmCompRoster::SetGeometry(f32 arg1, f32 arg2, f32 arg3, f32 arg4)
{
    return stub<thiscall_t<void, mmCompRoster*, f32, f32, f32, f32>>(0x4B7BA0, this, arg1, arg2, arg3, arg4);
}

void mmCompRoster::SetPosition(class mmTextNode* arg1, i32 arg2, f32 arg3)
{
    return stub<thiscall_t<void, mmCompRoster*, class mmTextNode*, i32, f32>>(0x4B7B20, this, arg1, arg2, arg3);
}

void mmCompRoster::SetReady(i32 arg1)
{
    return stub<thiscall_t<void, mmCompRoster*, i32>>(0x4B7A60, this, arg1);
}

void mmCompRoster::SetSubwidgetGeometry()
{
    return stub<thiscall_t<void, mmCompRoster*>>(0x4B7A80, this);
}

void mmCompRoster::Update()
{
    return stub<thiscall_t<void, mmCompRoster*>>(0x4B7A30, this);
}
