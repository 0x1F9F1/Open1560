...
inline extern_var(0x2608C8_Offset, f32*, TRIGMATH_ATANTABLE);

// 0x65E878 | ?TRIGMATH_COSTABLE@@3PAMA
inline extern_var(0x25E878_Offset, f32*, TRIGMATH_COSTABLE);

// 0x65F8A0 | ?TRIGMATH_TANTABLE@@3PAMA
inline extern_var(0x25F8A0_Offset, f32*, TRIGMATH_TANTABLE);

// 0x65A548 | ?asintable@@3PAMA
inline extern_var(0x25A548_Offset, f32*, asintable);
