...
{
    return stub<thiscall_t<void, mmPositions*, char*>>(0x92050_Offset, this, arg1);
}

i32 mmPositions::GetCount()
{
    return stub<thiscall_t<i32, mmPositions*>>(0x92010_Offset, this);
}

class Vector4& mmPositions::GetVector4(i32 arg1)
{
    return stub<thiscall_t<class Vector4&, mmPositions*, i32>>(0x92020_Offset, this, arg1);
}

void mmPositions::Init(i32 arg1)
{
    return stub<thiscall_t<void, mmPositions*, i32>>(0x91E10_Offset, this, arg1);
}

i32 mmPositions::Load(char* arg1)
{
    return stub<thiscall_t<i32, mmPositions*, char*>>(0x91E40_Offset, this, arg1);
}
...
i32 mmPositions::Recall(i32 arg1, class Matrix34* arg2, i32* arg3, char* arg4)
{
    return stub<thiscall_t<i32, mmPositions*, i32, class Matrix34*, i32*, char*>>(
        0x920F0_Offset, this, arg1, arg2, arg3, arg4);
}
