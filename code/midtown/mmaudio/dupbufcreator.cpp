...
{
    return stub<thiscall_t<void, DupBuffCreator*, char*, struct IDirectSoundBuffer*>>(0x4EED60, this, arg1, arg2);
}
...
struct IDirectSoundBuffer* DupBuffCreator::Create(char* arg1, i16* arg2, i32* arg3)
{
    return stub<thiscall_t<struct IDirectSoundBuffer*, DupBuffCreator*, char*, i16*, i32*>>(
        0x4EEC60, this, arg1, arg2, arg3);
}

struct IDirectSoundBuffer* DupBuffCreator::FindOriginal(char* arg1, i16* arg2)
{
    return stub<thiscall_t<struct IDirectSoundBuffer*, DupBuffCreator*, char*, i16*>>(0x4EEF00, this, arg1, arg2);
}

struct tWAVEFORMATEX* DupBuffCreator::GetWAVEFORMATEX(struct IDirectSoundBuffer* arg1)
{
    return stub<thiscall_t<struct tWAVEFORMATEX*, DupBuffCreator*, struct IDirectSoundBuffer*>>(0x4EEF90, this, arg1);
}
