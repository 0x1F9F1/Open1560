...
{
    return stub<thiscall_t<i32, aiPoliceForce*, class mmCar*, class mmCar*>>(0x4E860_Offset, this, arg1, arg2);
}

i32 aiPoliceForce::RegisterPerp(class mmCar* arg1, class mmCar* arg2)
{
    return stub<thiscall_t<i32, aiPoliceForce*, class mmCar*, class mmCar*>>(0x4E8D0_Offset, this, arg1, arg2);
}

void aiPoliceForce::Reset()
{
    return stub<thiscall_t<void, aiPoliceForce*>>(0x4E810_Offset, this);
}

i32 aiPoliceForce::State(class mmCar* arg1, class mmCar* arg2, f32 arg3)
{
    return stub<thiscall_t<i32, aiPoliceForce*, class mmCar*, class mmCar*, f32>>(
        0x4EA60_Offset, this, arg1, arg2, arg3);
}

i32 aiPoliceForce::UnRegisterCop(class mmCar* arg1, class mmCar* arg2)
{
    return stub<thiscall_t<i32, aiPoliceForce*, class mmCar*, class mmCar*>>(0x4E970_Offset, this, arg1, arg2);
}
