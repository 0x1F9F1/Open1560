...
{
    return stub<thiscall_t<u32, agiColorModel8*, u32, u32, u32, u32>>(0x15BF50_Offset, this, arg1, arg2, arg3, arg4);
}

u32 agiColorModel8::FindColor(struct agiRgba arg1)
{
    return stub<thiscall_t<u32, agiColorModel8*, struct agiRgba>>(0x15BF30_Offset, this, arg1);
}

u32 agiColorModel8::GetColor(struct agiRgba arg1)
{
    return stub<thiscall_t<u32, agiColorModel8*, struct agiRgba>>(0x15BF10_Offset, this, arg1);
}

u32 agiColorModel8::GetPixel(class agiSurfaceDesc* arg1, i32 arg2, i32 arg3)
{
    return stub<thiscall_t<u32, agiColorModel8*, class agiSurfaceDesc*, i32, i32>>(
        0x15C000_Offset, this, arg1, arg2, arg3);
}
