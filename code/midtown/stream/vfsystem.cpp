...
{
    return stub<thiscall_t<i32, VirtualFileSystem*, char*>>(0x560B90, this, arg1);
}

class Stream* VirtualFileSystem::CreateOn(char* arg1, void* arg2, i32 arg3)
{
    return stub<thiscall_t<class Stream*, VirtualFileSystem*, char*, void*, i32>>(0x560B80, this, arg1, arg2, arg3);
}

struct FileInfo* VirtualFileSystem::FirstEntry(char* arg1)
{
    return stub<thiscall_t<struct FileInfo*, VirtualFileSystem*, char*>>(0x560BB0, this, arg1);
}

i32 VirtualFileSystem::GetDir(char* arg1, i32 arg2)
{
    return stub<thiscall_t<i32, VirtualFileSystem*, char*, i32>>(0x560BA0, this, arg1, arg2);
}
...
{
    return stub<thiscall_t<i32, VirtualFileSystem*, char*, struct PagerInfo_t&>>(0x560A50, this, arg1, arg2);
}

i32 VirtualFileSystem::QueryOn(char* arg1)
{
    return stub<thiscall_t<i32, VirtualFileSystem*, char*>>(0x560A00, this, arg1);
}

i32 VirtualFileSystem::ValidPath(char* arg1)
{
    return stub<thiscall_t<i32, VirtualFileSystem*, char*>>(0x560780, this, arg1);
}
